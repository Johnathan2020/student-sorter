var students = ["sofia", "devin", "najely", "kassandra", "fatburger ricki",
"alejandra", "lashawnte", "xochi", "jimmie", "jonathan delgado", "andres",
"eric", "jonathan interiano", "scott", "javier", "lissette", "rodolfo", "twin",
...
console.log(students.indexOf("rafa"))
sortStudents(students, 2)

// console.log(students.sort()
console.log([2, 56, 5, 8, 1, 100].sort())
